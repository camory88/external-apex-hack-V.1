...
//this might not work
//template <class T>
//bool ReadArray(uint64_t addr, T out[], size_t size)
//{
//	NULL_MEMORY instructions;
//	instructions.pid = process_id;
//	instructions.size = sizeof(T) * size;
...
inline bool write_memory(UINT_PTR write_address, UINT_PTR source_address, SIZE_T write_size)
{
	NULL_MEMORY instructions;
